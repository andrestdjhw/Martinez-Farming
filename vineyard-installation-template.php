  ...
  <section aria-labelledby="cta-h" class="relative isolate overflow-hidden bg-noche-vinedo text-white">
    ...
    <div class="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:py-20">
      ...
      <div class="reveal">
        ...
        <h2 id="cta-h" class="mt-2 font-display text-4xl leading-tight sm:text-5xl">Planning a new vineyard?</h2>
        <p class="mt-5 max-w-md text-lg text-tierra-suave">From raw land to first harvest, let's build it right from day one.</p>
